...
public class RegistroVentasGUI extends JFrame {
    ...
    private void aplicarEstilos() {
        ...
        for (JButton boton : botones) {
            if (boton == agregarProductoButton) {
                boton.setBackground(Color.GREEN); // Fondo verde para el botón de agregar
            } else if (boton == eliminarButton) {
                boton.setBackground(Color.BLUE); // Fondo azul para el botón de eliminar
            } else if (boton == volverButton) {
                boton.setBackground(Color.RED); // Fondo rojo para el botón de salir
            } else {
                boton.setBackground(new Color(76, 175, 80)); // Fondo predeterminado para otros botones
            }
            boton.setFont(fuenteBotones);
            boton.setForeground(Color.BLACK); // Letras negras
            boton.setBorder(BorderFactory.createLineBorder(Color.BLACK)); // Marco negro
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            RegistroVentasGUI formVenta = new RegistroVentasGUI();
